<div class="clients index">
	...
	<tr>
		...
		<td><?php echo h($client['Client']['title']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['givenname']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['lastname']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['streetnumber']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['streetname']); ?>&nbsp;</td>
		...
		<td><?php echo h($client['Client']['homephone']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['mobilephone']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['note']); ?>&nbsp;</td>
		<td class="actions">
