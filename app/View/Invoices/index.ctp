<div class="invoices index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('photobefore'); ?></th>
			<th><?php echo $this->Paginator->sort('photoafter'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($invoice['Invoice']['photobefore']); ?>&nbsp;</td>
		<td><?php echo h($invoice['Invoice']['photoafter']); ?>&nbsp;</td>
		<td class="actions">
